...
tags:
  ...
  - Splunk Cloud
  - Network_Traffic
redirect_from: network/detect_outbound_smb_traffic/
---
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/network/detect_outbound_smb_traffic.yml) \| *version*: **3**