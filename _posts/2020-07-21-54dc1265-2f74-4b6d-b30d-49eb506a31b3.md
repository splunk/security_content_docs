...
tags:
  ...
  - Splunk Cloud
  - Network_Traffic
redirect_from: network/protocol_or_port_mismatch/
---
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/network/protocol_or_port_mismatch.yml) \| *version*: **2**