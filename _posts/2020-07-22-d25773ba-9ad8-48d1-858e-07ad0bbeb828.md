...
tags:
  ...
  - Splunk Cloud
  - Network_Traffic
redirect_from: network/smb_traffic_spike_-_mltk/
---
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/network/smb_traffic_spike_-_mltk.yml) \| *version*: **3**