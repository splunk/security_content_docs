...
tags:
  ...
  - Endpoint_Processes
redirect_from: deprecated/unusual_lolbas_in_short_period_of_time/
---
...
> :information_source:
> **unusual_lolbas_in_short_period_of_time_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/deprecated/unusual_lolbas_in_short_period_of_time.yml) \| *version*: **2**