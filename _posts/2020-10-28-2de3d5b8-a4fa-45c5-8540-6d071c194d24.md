...
tags:
  ...
  - Splunk Cloud
redirect_from: network/detect_port_security_violation/
---
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/network/detect_port_security_violation.yml) \| *version*: **1**