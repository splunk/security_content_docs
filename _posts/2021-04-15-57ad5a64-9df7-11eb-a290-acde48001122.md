...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/windows_multiple_invalid_users_failed_to_authenticate_using_ntlm/
---
...
> :information_source:
> **windows_multiple_invalid_users_failed_to_authenticate_using_ntlm_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
* [https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1110.003/purplesharp_invalid_users_ntlm_xml/windows-security.log](https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1110.003/purplesharp_invalid_users_ntlm_xml/windows-security.log)



[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_multiple_invalid_users_failed_to_authenticate_using_ntlm.yml) \| *version*: **2**