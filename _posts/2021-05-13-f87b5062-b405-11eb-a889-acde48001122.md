...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/cmlua_or_cmstplua_uac_bypass/
---
...
| stats count min(_time) as firstTime max(_time) as lastTime by dest Image ImageLoaded process_name Computer EventCode Signed ProcessId 
...
| ----------- | ----------- |--------------|--------------|
| 80.0 | 80 | 100 | The following module $ImageLoaded$ was loaded by a non-standard application on endpoint $dest$ |
