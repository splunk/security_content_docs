...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/rundll32_create_remote_thread_to_a_process/
---
...
| ----------- | ----------- |--------------|--------------|
| 56.0 | 70 | 80 | rundl32 process $SourceImage$ create a remote thread to process $TargetImage$ in host $dest$ |
