...
tags:
  ...
  - Splunk Cloud
redirect_from: cloud/gsuite_suspicious_calendar_invite/
---
...
| ----------- | ----------- |--------------|--------------|
| 25.0 | 50 | 50 | Gsuite suspicious calendar invite sent by $email$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/gsuite_suspicious_calendar_invite.yml) \| *version*: **1**