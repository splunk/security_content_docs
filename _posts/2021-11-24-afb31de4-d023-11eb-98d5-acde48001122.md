...
redirect_from: endpoint/attempt_to_disable_services/
---
...
| where process_cmd_line LIKE "%config%" AND process_cmd_line LIKE "%disabled%" AND process_file_name="sc.exe" --finding_report--
```
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/attempt_to_disable_services.yml) \| *version*: **6**