...
| where match_regex(process_cmd_line, /(?i)grant/)=true AND (process_file_name="icacls.exe" OR process_file_name="xcacls.exe" OR process_file_name="cacls.exe") --finding_report--
```
