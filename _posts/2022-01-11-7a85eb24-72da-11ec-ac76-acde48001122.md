...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/linux_possible_access_or_modification_of_sshd_config_file/
---
...
| ID          | Technique   | Tactic         |
| ----------- | ----------- |--------------- |
| [T1098.004](https://attack.mitre.org/techniques/T1098/004/) | SSH Authorized Keys | Persistence, Privilege Escalation |
