...
| where (process_file_name="certutil.exe" AND process_cmd_line LIKE "%split%" AND process_cmd_line LIKE "%urlcache%") OR process_cmd_line LIKE "%urlcache%" --finding_report--
```
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_certutil_urlcache_download.yml) \| *version*: **3**