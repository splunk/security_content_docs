...
| where (process_file_name="certutil.exe" AND like(process_cmd_line, "%split%") AND like(process_cmd_line, "%verifyctl%")) OR like(process_cmd_line, "%verifyctl%") --finding_report--
```
