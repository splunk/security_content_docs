...
| where (like(process_cmd_line, "%about%") OR like(process_cmd_line, "%javascript%") OR like(process_cmd_line, "%vbscript%")) AND process_file_name="rundll32.exe" --finding_report--
```
