...
| where like(actor_process_file_name, "%mshta.exe") AND (process_file_name="wscript.exe" OR process_file_name="cscript.exe" OR process_file_name="searchprotocolhost.exe" OR process_file_name="microsoft.workflow.compiler.exe" OR process_file_name="msbuild.exe" OR process_file_name="colorcpl.exe" OR process_file_name="scrcons.exe" OR process_file_name="cmd.exe" OR process_file_name="powershell.exe") --finding_report--
```
