...
| stats values(userPrincipalName) as userPrincipalName by _time, ipAddress, status.additionalDetails, appDisplayName, userAgent 
...
| ----------- | ----------- |--------------|--------------|
| 54.0 | 60 | 90 | User $userPrincipalName$ failed to pass MFA challenge |
