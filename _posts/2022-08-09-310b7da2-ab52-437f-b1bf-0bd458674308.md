---
title: "Linux GDB Privilege Escalation"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/linux_gdb_privilege_escalation/
---
...
GDB is the acronym for GNU Debugger. This tool helps to debug the programs written in C, C++, Ada, Fortran, etc. The console can be opened using the gdb command on terminal. If sudo right is given to GDB tool for the user, then the user can run system commands as root and possibly get a root shell.
...
> :information_source:
> **linux_gdb_privilege_escalation_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
* [https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1548/gdb/sysmon_linux.log](https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1548/gdb/sysmon_linux.log)



[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/linux_gdb_privilege_escalation.yml) \| *version*: **1**