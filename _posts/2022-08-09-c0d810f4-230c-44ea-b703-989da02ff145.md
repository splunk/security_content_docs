---
title: "Linux MySQL Privilege Escalation"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/linux_mysql_privilege_escalation/
---
...
> :information_source:
> **linux_mysql_privilege_escalation_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
* [https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1548/mysql/sysmon_linux.log](https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1548/mysql/sysmon_linux.log)



[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/linux_mysql_privilege_escalation.yml) \| *version*: **1**