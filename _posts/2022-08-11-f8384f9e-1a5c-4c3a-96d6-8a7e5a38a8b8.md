---
title: "Linux Csvtool Privilege Escalation"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/linux_csvtool_privilege_escalation/
---
...
csvtool is an easy to use command-line tool to work with .CSV files. If sudo right is given to the tool for the user, then the user can run system commands as root and possibly get a root shell.
...
> :information_source:
> **linux_csvtool_privilege_escalation_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
* [https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1548/csvtool/sysmon_linux.log](https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1548/csvtool/sysmon_linux.log)



[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/linux_csvtool_privilege_escalation.yml) \| *version*: **1**