...
```
`azuread` operationName="Add member to role"  properties.targetResources{}.modifiedProperties{}.newValue="\"Global Administrator\"" 
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/azure_ad_global_administrator_role_assigned.yml) \| *version*: **3**