...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/windows_installutil_credential_theft/
---
...
```
`sysmon` EventCode=7  parent_process_name=installutil.exe ImageLoaded IN ("*\\samlib.dll", "*\\vaultcli.dll") 
...
| ----------- | ----------- |--------------|--------------|
| 80.0 | 80 | 100 | An instance of $parent_process_name$ spawning $ImageLoaded$ was identified on endpoint $dest$ loading samlib.dll and vaultcli.dll to potentially capture credentials in memory. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_installutil_credential_theft.yml) \| *version*: **3**