---
title: "Windows System Binary Proxy Execution MSIExec Remote Download"
excerpt: "Msiexec"
categories:
  - Endpoint
...
tags:
  ...
  - Endpoint_Processes
redirect_from: endpoint/windows_system_binary_proxy_execution_msiexec_remote_download/
---
...
| where cmd_line IS NOT NULL AND process_name IS NOT NULL AND process_name="msiexec.exe" AND (like (cmd_line, "%http://%") OR like (cmd_line, "%https://%")) 
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_system_binary_proxy_execution_msiexec_remote_download.yml) \| *version*: **1**