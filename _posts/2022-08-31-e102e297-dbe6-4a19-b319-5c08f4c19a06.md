...
| where ((process_cmd_line LIKE "%-ma %" OR process_cmd_line LIKE "%-mm %") AND (process_file_name="procdump64.exe" OR process_file_name="procdump.exe")) AND process_cmd_line LIKE "%lsass%" --finding_report--
```
