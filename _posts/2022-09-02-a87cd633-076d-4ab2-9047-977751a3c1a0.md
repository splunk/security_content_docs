...
```
 `azuread` body.operationName="Set domain authentication" "body.properties.result"=success 
...
| ----------- | ----------- |--------------|--------------|
| 81.0 | 90 | 90 | A new federated domain, $domain$ , was added by $initiatedBy$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/azure_ad_new_federated_domain_added.yml) \| *version*: **1**