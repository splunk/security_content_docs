---
title: "Windows Unusual Count Of Users Remotely Failed To Auth From Host"
...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/windows_unusual_count_of_users_remotely_failed_to_auth_from_host/
---
...
> :information_source:
> **windows_unusual_count_of_users_remotely_failed_to_auth_from_host_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | Potential password spraying attack on $Computer$ |
...
* [https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1110.003/purplesharp_remote_spray_xml/windows-security.log](https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/attack_techniques/T1110.003/purplesharp_remote_spray_xml/windows-security.log)



[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_unusual_count_of_users_remotely_failed_to_auth_from_host.yml) \| *version*: **1**