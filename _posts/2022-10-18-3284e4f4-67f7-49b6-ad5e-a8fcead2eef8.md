...
| where process_file_name="advpack.dll" AND (NOT match(process_file_path, /(?i)\\windows\\syswow64/)=true) --finding_report--
```
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_rename_system_utilities_advpack_dll_lolbas_in_non_standard_path.yml) \| *version*: **4**