---
title: "Windows Rename System Utilities At exe LOLBAS in Non Standard Path"
...
tags:
  ...
  - Endpoint_Processes
redirect_from: endpoint/windows_rename_system_utilities_at_exe_lolbas_in_non_standard_path/
---
...
| where process_name IS NOT NULL AND process_name="at.exe"
...
> :information_source:
> **windows_rename_system_utilities_at_exe_lolbas_in_non_standard_path_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_rename_system_utilities_at_exe_lolbas_in_non_standard_path.yml) \| *version*: **1**