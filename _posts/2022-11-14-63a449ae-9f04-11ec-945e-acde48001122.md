...
The following analytic detects a suspicious registry modification used to disable windows features. This technique has been identified in several ransomware malware families to impair the compromised host and make it harder for analysts to mitigate or respond to an attack.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_disable_windows_group_policy_features_through_registry.yml) \| *version*: **3**