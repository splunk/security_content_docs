...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_powershell_disabled_kerberos_pre-authentication_discovery_get-aduser.yml) \| *version*: **2**