...
excerpt: "Private Keys, Unsecured Credentials"
categories:
  - Endpoint
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_private_keys_discovery/
---
...
> :information_source:
> **windows_private_keys_discovery_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 25.0 | 50 | 50 | a process with commandline $process$ that can retrieve information related to private keys in $dest$ |
...
* [https://attack.mitre.org/techniques/T1552/004/](https://attack.mitre.org/techniques/T1552/004/)
...
* [https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/malware/winpeas/winpeas_search_private_key/dir-private-sysmon.log](https://media.githubusercontent.com/media/splunk/attack_data/master/datasets/malware/winpeas/winpeas_search_private_key/dir-private-sysmon.log)



[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_private_keys_discovery.yml) \| *version*: **1**