...
| ----------- | ----------- | -------------- |
| [CVE-2023-22941](https://nvd.nist.gov/vuln/detail/CVE-2023-22941) | In Splunk Enterprise versions below 8.1.13, 8.2.10, and 9.0.4, an improperly-formatted ‘INGEST_EVAL’ parameter in a [Field Transformation](https://docs.splunk.com/Documentation/Splunk/latest/Knowledge/Managefieldtransforms) crashes the Splunk daemon (splunkd). | None |
