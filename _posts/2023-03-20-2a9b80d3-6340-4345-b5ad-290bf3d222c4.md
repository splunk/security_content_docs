...
tags:
  ...
  - Splunk Cloud
redirect_from: cloud/aws_ec2_snapshot_shared_externally/
---
...
> :information_source:
> **aws_ec2_snapshot_shared_externally_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/aws_ec2_snapshot_shared_externally.yml) \| *version*: **3**