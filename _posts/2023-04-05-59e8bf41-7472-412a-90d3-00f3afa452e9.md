...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/windows_exfiltration_over_c2_via_powershell_uploadstring/
---
...
> :information_source:
> **windows_exfiltration_over_c2_via_powershell_uploadstring_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_exfiltration_over_c2_via_powershell_uploadstring.yml) \| *version*: **1**