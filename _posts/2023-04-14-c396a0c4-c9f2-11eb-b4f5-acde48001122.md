...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/powershell_using_memory_as_backing_store/
---
...
| ----------- | ----------- |--------------|--------------|
| 40.0 | 50 | 80 | A PowerShell script contains memorystream command in $ScriptBlockText$ as new object backstore with EventCode $EventCode$ on host $Computer$. |
