...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_modify_registry_updateserviceurlalternate/
---
...
> :information_source:
> **windows_modify_registry_updateserviceurlalternate_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_modify_registry_updateserviceurlalternate.yml) \| *version*: **1**