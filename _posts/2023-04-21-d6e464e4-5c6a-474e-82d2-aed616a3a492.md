...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/impacket_lateral_movement_wmiexec_commandline_parameters/
---
...
> :information_source:
> **impacket_lateral_movement_wmiexec_commandline_parameters_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 63.0 | 90 | 70 | Suspicious command-line parameters on $dest$ may represent lateral movement using wmiexec. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/impacket_lateral_movement_wmiexec_commandline_parameters.yml) \| *version*: **1**