...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/linux_deletion_of_ssl_certificate/
---
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | SSL certificate deleted on host $dest$ by process GUID- $process_guid$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/linux_deletion_of_ssl_certificate.yml) \| *version*: **2**