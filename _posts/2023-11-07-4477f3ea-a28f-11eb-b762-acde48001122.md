...
tags:
  ...
  - Splunk Cloud
redirect_from: network/multiple_archive_files_http_post_traffic/
---
...
| ----------- | ----------- |--------------|--------------|
| 25.0 | 50 | 50 | A http post $http_method$ sending packet with possible archive bytes header $http_request_body$ in uri path $uri_path$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/network/multiple_archive_files_http_post_traffic.yml) \| *version*: **2**