...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/rundll32_process_creating_exe_dll_files/
---
...
| ----------- | ----------- |--------------|--------------|
| 80.0 | 80 | 100 | rundll32 process drops a file $TargetFilename$ on host $dest$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/rundll32_process_creating_exe_dll_files.yml) \| *version*: **2**