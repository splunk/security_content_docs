...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_credentials_from_password_stores_deletion/
---
...
> :information_source:
> **windows_credentials_from_password_stores_deletion_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 64.0 | 80 | 80 | a process $process_name$ was executed in $dest$ to delete stored credentials |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_credentials_from_password_stores_deletion.yml) \| *version*: **1**