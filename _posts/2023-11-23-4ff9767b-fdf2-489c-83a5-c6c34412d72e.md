---
title: "Windows Modify Registry DontShowUI"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_modify_registry_dontshowui/
---
...
> :information_source:
> **windows_modify_registry_dontshowui_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | the registry for WER settings was modified to be disable show UI on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_modify_registry_dontshowui.yml) \| *version*: **1**