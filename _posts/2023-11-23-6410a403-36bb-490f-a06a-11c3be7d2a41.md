...
tags:
  ...
  - Authentication
  - Endpoint
redirect_from: endpoint/windows_modify_registry_authenticationleveloverride/
---
...
> :information_source:
> **windows_modify_registry_authenticationleveloverride_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | the registry for authentication level settings was modified on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_modify_registry_authenticationleveloverride.yml) \| *version*: **1**