...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_modify_registry_proxyenable/
---
...
> :information_source:
> **windows_modify_registry_proxyenable_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | the registry settings was modified to enable proxy on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_modify_registry_proxyenable.yml) \| *version*: **1**