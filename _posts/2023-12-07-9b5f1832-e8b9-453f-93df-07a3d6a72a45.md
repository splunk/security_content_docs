...
tags:
  ...
  - Splunk Cloud
redirect_from: cloud/kubernetes_unauthorized_access/
---
...
> :information_source:
> **kubernetes_unauthorized_access_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/kubernetes_unauthorized_access.yml) \| *version*: **1**