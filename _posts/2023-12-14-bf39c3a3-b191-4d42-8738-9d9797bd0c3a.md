...
tags:
  ...
  - Splunk Cloud
redirect_from: cloud/kubernetes_daemonset_deployed/
---
...
> :information_source:
> **kubernetes_daemonset_deployed_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | DaemonSet deployed to Kubernetes by user $user$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/kubernetes_daemonset_deployed.yml) \| *version*: **1**