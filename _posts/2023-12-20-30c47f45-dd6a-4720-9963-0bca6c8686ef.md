...
| ----------- | ----------- |--------------|--------------|
| 54.0 | 60 | 90 | A new custom domain, $domain$ , was added by $user$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/azure_ad_new_custom_domain_added.yml) \| *version*: **2**