...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/get_aduserresultantpasswordpolicy_with_powershell_script_block/
---
...
| ----------- | ----------- |--------------|--------------|
| 9.0 | 30 | 30 | powershell process having commandline to query domain user password policy detected on host - $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/get_aduserresultantpasswordpolicy_with_powershell_script_block.yml) \| *version*: **3**