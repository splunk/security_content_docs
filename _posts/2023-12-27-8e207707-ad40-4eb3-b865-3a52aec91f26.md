---
title: "Windows Modify Registry Disable WinDefender Notifications"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_modify_registry_disable_windefender_notifications/
---
...
> :information_source:
> **windows_modify_registry_disable_windefender_notifications_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_modify_registry_disable_windefender_notifications.yml) \| *version*: **1**