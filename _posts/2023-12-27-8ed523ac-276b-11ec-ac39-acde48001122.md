...
| ----------- | ----------- |--------------|--------------|
| 90.0 | 90 | 100 | Modified/added/deleted registry entry $registry_path$ in $dest$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/etw_registry_disabled.yml) \| *version*: **4**