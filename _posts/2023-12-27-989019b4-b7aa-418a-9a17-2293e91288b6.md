---
title: "Windows Modify Registry DisableSecuritySettings"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_modify_registry_disablesecuritysettings/
---
...
> :information_source:
> **windows_modify_registry_disablesecuritysettings_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | the registry for terminal services settings was modified to disable security settings on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_modify_registry_disablesecuritysettings.yml) \| *version*: **1**