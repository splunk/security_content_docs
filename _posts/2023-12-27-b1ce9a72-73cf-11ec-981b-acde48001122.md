...
| ----------- | ----------- |--------------|--------------|
| 64.0 | 80 | 80 | A process, $parent_process_path$, has loaded $TargetImage$ that are typically related to credential dumping on $dest$. Review for further details. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_non-system_account_targeting_lsass.yml) \| *version*: **2**