...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/powershell_domain_enumeration/
---
...
| ----------- | ----------- |--------------|--------------|
| 42.0 | 60 | 70 | A suspicious powershell script contains domain enumeration command in $ScriptBlockText$ with EventCode $EventCode$ in host $dest$ |
