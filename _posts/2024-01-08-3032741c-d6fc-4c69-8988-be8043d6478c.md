---
title: "Windows Impair Defense Disable Controlled Folder Access"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_impair_defense_disable_controlled_folder_access/
---
...
> :information_source:
> **windows_impair_defense_disable_controlled_folder_access_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | Windows Defender ControlledFolderAccess feature set to disable on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_impair_defense_disable_controlled_folder_access.yml) \| *version*: **1**