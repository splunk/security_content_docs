---
title: "Windows Impair Defense Disable Defender Firewall And Network"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_impair_defense_disable_defender_firewall_and_network/
---
...
> :information_source:
> **windows_impair_defense_disable_defender_firewall_and_network_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | Windows Defender firewall and network protection section feature set to disable on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_impair_defense_disable_defender_firewall_and_network.yml) \| *version*: **1**