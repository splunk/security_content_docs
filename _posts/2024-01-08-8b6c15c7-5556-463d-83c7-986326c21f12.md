---
title: "Windows Impair Defense Disable Win Defender Network Protection"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_impair_defense_disable_win_defender_network_protection/
---
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | Windows Defender Exploit Guard network protection set to disable on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_impair_defense_disable_win_defender_network_protection.yml) \| *version*: **1**