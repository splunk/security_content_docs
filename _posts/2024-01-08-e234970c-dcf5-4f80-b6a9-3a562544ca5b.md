---
title: "Windows Impair Defense Disable Web Evaluation"
...
tags:
  ...
  - Endpoint
  - Web
redirect_from: endpoint/windows_impair_defense_disable_web_evaluation/
---
...
> :information_source:
> **windows_impair_defense_disable_web_evaluation_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_impair_defense_disable_web_evaluation.yml) \| *version*: **1**