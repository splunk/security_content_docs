---
title: "Windows Impair Defense Change Win Defender Tracing Level"
...
tags:
  ...
  - Splunk Cloud
  - Endpoint
redirect_from: endpoint/windows_impair_defense_change_win_defender_tracing_level/
---
...
> :information_source:
> **windows_impair_defense_change_win_defender_tracing_level_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
| ----------- | ----------- |--------------|--------------|
| 49.0 | 70 | 70 | Windows Defender WppTracingLevel registry was modified on $dest$. |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/windows_impair_defense_change_win_defender_tracing_level.yml) \| *version*: **1**