...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/create_remote_thread_in_shell_application/
---
...
| ----------- | ----------- |--------------|--------------|
| 70.0 | 70 | 100 | process $process_name$ create a remote thread to shell app process $TargetImage$ in host $dest$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/create_remote_thread_in_shell_application.yml) \| *version*: **2**