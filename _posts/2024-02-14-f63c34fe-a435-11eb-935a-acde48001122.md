...
tags:
  ...
  - Splunk Cloud
redirect_from: endpoint/executable_file_written_in_administrative_smb_share/
---
...
| ----------- | ----------- |--------------|--------------|
| 70.0 | 70 | 100 | $src_user$ dropped or created an executable file in known sensitive SMB share.  Share name=$ShareName$, Target name=$RelativeTargetName$, and Access mask=$AccessMask$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/endpoint/executable_file_written_in_administrative_smb_share.yml) \| *version*: **3**