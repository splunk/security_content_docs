...
tags:
  ...
  - Splunk Cloud
  - Network_Resolution
redirect_from: network/detect_remote_access_software_usage_dns/
---
...
> :information_source:
> **detect_remote_access_software_usage_dns_filter** is a empty macro by default. It allows the user to filter out any results (false positives) without editing the SPL.
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/network/detect_remote_access_software_usage_dns.yml) \| *version*: **1**