...
tags:
  ...
  - Splunk Cloud
redirect_from: cloud/gsuite_outbound_email_with_attachment_to_external_domain/
---
...
| ----------- | ----------- |--------------|--------------|
| 9.0 | 30 | 30 | Suspicious email from $src_domain_list$ to $dest_domain$ |
...
[*source*](https://github.com/splunk/security_content/tree/develop/detections/cloud/gsuite_outbound_email_with_attachment_to_external_domain.yml) \| *version*: **2**