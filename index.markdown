...
excerpt: "Get the latest **FREE** Enterprise Security Content Update (ESCU) App with **1427** analytics. 🚀 [See what is new](https://github.com/splunk/security_content/releases/latest)!"
feature_row:
  - image_path: /static/feature_detection.png
    alt: "customizable"
    title: "Detections"
    excerpt: "See all **1427** Splunk Analytics built to find evil 😈."
    url: "/detections"
