...
excerpt: "Get the latest **FREE** Enterprise Security Content Update (ESCU) App with **1287** analytics. 🚀 [See what is new](https://github.com/splunk/security_content/releases/latest)!"
feature_row:
  - image_path: /static/feature_detection.png
    alt: "customizable"
    title: "Detections"
    excerpt: "See all **1287** Splunk Analytics built to find evil 😈."
    url: "/detections"
  ...
  - image_path: /static/feature_stories.png
    ...
    excerpt: "See all **171** use cases, 📦 of detections built to address a threat."
    url: "/stories"
    btn_class: "btn--primary"
    btn_label: "Explore"
  - image_path: /static/feature_playbooks.png
    alt: "100% free"
    title: "Playbooks"
    excerpt: "See all **46** sets of steps 🐾 to automatically respond to a threat."
    url: "/playbooks"
    btn_class: "btn--primary"
    btn_label: "Explore"
---
